...
public class DosenMain {
    ...
    public static void main(String[] args) {
        ...
        while (pilihan) {
            ...
            System.out.println("5. Cari Berdasarkan Nama Dosen");
            System.out.println("6. Cari Berdasarkan Usia");
            ...
            switch (choose) {
                ...
                case 5:
                    ...
                    list.tampilDataSearch07(posisi);
                    break;
                    case 6: 
                    System.out.print("Masukkan usia yang ingin dicari: ");
                    int age = sc.nextInt();
                    list.SortingDSC();
                    int posisi2 = list.PencarianDataBinary07(0, age, 0, dsn.length-1);
                    list.tampilDataSearch07(posisi2);
                    break;
                default:
                    break;
            }
